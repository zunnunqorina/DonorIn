...
if (isset($_POST['kirim_relawan'])) {
    ...
    $query = "INSERT INTO relawan (nama, email, no_hp, tgl_lahir, umur, jenis_kelamin, goldar, berat_badan, alamat, kota, pekerjaan, pernah_donor, terakhir_donor)
              VALUES ('$nama','$email','$no_hp','$tgl',$umur,'$jenis_kelamin','$goldar',$berat_badan,'$alamat','$kota','$pekerjaan','$pernah_donor',$terakhir_donor)";
