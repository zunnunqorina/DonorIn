...
$q_data = $conn->prepare("SELECT * FROM relawan $where ORDER BY tanggal_daftar DESC LIMIT ? OFFSET ?");
...
function konfirmasiHapus(id, nama) {
    hapusDataSweet(id, nama, 'relawan_admin.php?hapus=');
}
