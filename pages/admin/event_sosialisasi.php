...
$q_data = $conn->prepare("SELECT * FROM event_sosialisasi $where ORDER BY tanggal DESC LIMIT :lim OFFSET :off");
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="event_donor.php" class="nav-item"><i class="fas fa-calendar-alt"></i> Event Donor Darah
                <span class="nav-badge"><?= $total_ev_donor ?></span>
            </a>
            <a href="event_sosialisasi.php" class="nav-item active"><i class="fas fa-bullhorn"></i> Event Sosialisasi
...
function konfirmasiHapus(id, judul) {
    ...
    document.getElementById('hapus_link').href = 'event_sosialisasi.php?hapus=' + id;
